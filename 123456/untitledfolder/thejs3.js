...
var wordcounter = 0;
var spell = 0;
gamewords = ["Piano", "Dance", "Film","Language","Music", "Photography"];
gamemeaning = ["Piano:The piano is an acoustic, stringed musical instrument, in which the strings are struck by hammers. It is played using a keyboard,which is a row of keys (small levers) that the performer presses down or strikes with the fingers and thumbs of both hands to cause the hammers to strike the strings","Dance: to move the feet and body in a rhythmic way, usually to music", "Film: a motion picture; movie.", "Language: a particular system used by people of the same nation, region, or group to talk with one another","Music: sound with tones and rhythm that can be listened to and enjoyed", "Photography: the practice of taking photographs"];
